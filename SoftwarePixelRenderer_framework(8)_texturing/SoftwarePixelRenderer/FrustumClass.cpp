...
VERTEX CFrustumClass::IntersectPlane(XMFLOAT4& v4Plane, VERTEX* vtxStart, VERTEX* vtxEnd)
{
	...
	//Texture
	XMFLOAT2 v2UvStart, v2UvEnd;
	v2UvStart.x = vtxStart->v2UV.x * (1.f - fRate);
	v2UvStart.y = vtxStart->v2UV.y * (1.f - fRate);
	v2UvEnd.x = vtxEnd->v2UV.x * fRate;
	v2UvEnd.y = vtxEnd->v2UV.y * fRate;

	vtxNew.v2UV.x = v2UvStart.x + v2UvEnd.x;
	vtxNew.v2UV.y = v2UvStart.y + v2UvEnd.y;
