...
void CCube::Initialize()
{
	...
	*/
	...
	vecVertices[0].v3UV.x = 0;
	vecVertices[0].v3UV.y = 1;
	vecVertices[1].v3UV.x = 1;
	vecVertices[1].v3UV.y = 1;
	vecVertices[2].v3UV.x = 1;
	vecVertices[2].v3UV.y = 0;
	vecVertices[3].v3UV.x = 0;
	vecVertices[3].v3UV.y = 0;
