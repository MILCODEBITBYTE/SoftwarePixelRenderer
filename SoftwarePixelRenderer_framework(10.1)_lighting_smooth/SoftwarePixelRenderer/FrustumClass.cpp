...
VERTEX CFrustumClass::IntersectPlane(XMFLOAT4& v4Plane, VERTEX* vtxStart, VERTEX* vtxEnd)
{
	...
	//Texture
	XMFLOAT3 v3UvStart, v3UvEnd;
	v3UvStart.x = vtxStart->v3UV.x * (1.f - fRate);
	v3UvStart.y = vtxStart->v3UV.y * (1.f - fRate);
	v3UvStart.z = vtxStart->v3UV.z * (1.f - fRate);
	v3UvEnd.x = vtxEnd->v3UV.x * fRate;
	v3UvEnd.y = vtxEnd->v3UV.y * fRate;
	v3UvEnd.z = vtxEnd->v3UV.z * fRate;

	vtxNew.v3UV.x = v3UvStart.x + v3UvEnd.x;
	vtxNew.v3UV.y = v3UvStart.y + v3UvEnd.y;
	vtxNew.v3UV.z = v3UvStart.z + v3UvEnd.z;
