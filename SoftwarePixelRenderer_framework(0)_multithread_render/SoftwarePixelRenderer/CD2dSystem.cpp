...
ID2D1RenderTarget* CD2dSystem::GetWicRenderTarget() const
{
	return m_ipWicRenderTarget[m_iSwapIndex];
}

IWICBitmap* CD2dSystem::GetBackbuffer()
{
	return m_pBack[(m_iSwapIndex+1)%2];
}

IWICBitmap* CD2dSystem::GetRenderbuffer()
{
	return m_pBack[m_iSwapIndex];
}
